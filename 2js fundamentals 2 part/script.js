...
// const types = [];
//
// for (let i = 0; i < dimaArray.length; i++) {
//     console.log(dimaArray[i]);
//     // types[i] = typeof dimaArray[i]
//     // types.push(typeof dimaArray[i]);
// }
// console.log(types);
//
...
// continue and break
// for (let i = 0; i < dimaArray.length; i++) {
//     if (typeof dimaArray[i] !== 'string') continue;
//     console.log(dimaArray[i]);
// }

// for (let i = 0; i < dimaArray.length; i++) {
//     if (typeof dimaArray[i] === 'number') break;
//     console.log(dimaArray[i]);
// }
...
//     let percent = `${((population / 7_900_000_000) * 100).toFixed(2)}%`;
//     return percent;
// }
//
// for (let i = 0; i < populations.length; i++) {
//     percantages2.push(percantageOfWorld1(populations[i]));
// }
//
...
// for (let i = dimaArray.length - 1; i >= 0; i--) {
//     console.log(i, dimaArray[i]);
// }
...
//     // 0 
//     currentArray = listOfNeighbours[i]

//     for (let n = 0; n < currentArray.length; n++) {
//         console.log(`Country - ${currentArray[n]}`)
//     }
// }
...
function calcAverage (arr) {
   ...
   return `Avarage value - ${sum / arr.length}`
}
